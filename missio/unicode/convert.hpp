...
MISSIO_EXPORT std::string normalize(std::string const& str, normalization norm = nfc);
MISSIO_EXPORT std::u16string normalize(std::u16string const& str, normalization norm = nfc);
MISSIO_EXPORT std::u32string normalize(std::u32string const& str, normalization norm = nfc);
