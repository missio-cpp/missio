...
BOOST_DATA_TEST_CASE(utf8_fold_string_case_test, boost::unit_test::data::make(original_utf8) ^ casefold_utf8, original, casefold)
{
    BOOST_CHECK(missio::unicode::fold_case(std::string(original)) == std::string(casefold));
}
...
BOOST_DATA_TEST_CASE(utf16_fold_string_case_test, boost::unit_test::data::make(original_utf16) ^ casefold_utf16, original, casefold)
{
    BOOST_CHECK(missio::unicode::fold_case(std::u16string(original)) == std::u16string(casefold));
}
...
BOOST_DATA_TEST_CASE(utf32_fold_string_case_test, boost::unit_test::data::make(original_utf32) ^ casefold_utf32, original, casefold)
{
    BOOST_CHECK(missio::unicode::fold_case(std::u32string(original)) == std::u32string(casefold));
}
